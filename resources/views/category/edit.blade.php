...
<center><h2>商品分类添加表</h2><hr></center>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="firstname"
                   placeholder="请输入分类名称" name='cate_name' value="{{$data->cate_name}}">
        ...
        <div class="col-sm-10">
           <select class="form-control" id="firstname" name='p_id'>
               ...
               @foreach($p_data as $k=>$v)
                    <option value="{{$v->p_id}}" @if($v->p_id==$data->p_id) checked @endif>{{$v->cate_name}}</option>
                @endforeach
           </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type='submit' value="修改" class="btn btn-default" id="but">
